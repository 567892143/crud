    ...
    const [formData, setFormData] = useState({
      ...
      return (
        <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-xl">
          <h1 className="text-3xl font-bold mb-4 text-center">Update User by username</h1>
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2">Enter ur old username:</label>
              <input
                type="text"
                name="name"
                value={formData.name}
